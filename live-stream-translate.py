...
STREAMING_LIMIT = 30000  # 30 seconds in millisecones: shortened for demo purposes, the duration limit is ~5 minutes
SAMPLE_RATE = 16000
...
def listen_print_loop(responses, stream):
    ...
    for response in responses:
        ...
        if result.is_final:
            ...
            # one of our keywords.
            if re.search(r"\b(再見)\b", transcript, re.I):
            ...
            sys.stdout.write("\033[K")
            sys.stdout.write(str(corrected_time) + ": " + transcript + overwrite_chars + "\r")
            sys.stdout.flush()
